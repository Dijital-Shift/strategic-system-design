      ...
      <section className="py-24 lg:py-32 bg-card">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl border-l-2 border-accent pl-8">
            ...
            <p className="text-lg md:text-xl text-foreground leading-relaxed">We work with organizations that have built something meaningful and now require systems that can support their ambition. This work begins where original scope is no longer sufficient.  </p>
          </div>
        </div>
      </section>
