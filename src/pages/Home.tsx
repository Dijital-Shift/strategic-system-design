        ...
        <div className="container mx-auto px-6 lg:px-12 py-24">
          <div className="max-w-4xl">
            ...
            <div className="animate-fade-in" style={{ animationDelay: "0.2s" }}>
              <Button asChild variant="outline" size="lg" className="border-border hover:bg-secondary hover:text-foreground">
      ...
      <section className="py-24 lg:py-32">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link
              to="/about"
              className="group p-8 border border-border bg-background hover:bg-card transition-colors duration-300"
            >
